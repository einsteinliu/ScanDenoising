...
class SegNet(nn.Module):
    ...
    def forward(self, x):
        ...
        conv1 = Func.interpolate(Func.leaky_relu(self.conv1_bn(self.conv1(x))),scale_factor=0.5) #50,32,32,32        
        conv2 = Func.interpolate(Func.leaky_relu(self.conv2_bn(self.conv2(conv1))),scale_factor=0.5) #50,64,16,16
        conv3 = Func.interpolate(Func.leaky_relu(self.conv3_bn(self.conv3(conv2))),scale_factor=0.5) #50,128,8,8
